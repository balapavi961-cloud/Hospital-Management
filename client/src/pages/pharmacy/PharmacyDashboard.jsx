...
import { Pill, Package, CheckCircle, Clock, TrendingUp } from 'lucide-react';
import { getPharmacyStats, getPrescriptions } from '../../services/pharmacyService';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Manage prescriptions and medication dispensing</p>
                </div>
                <button
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm">
                <div className="p-6 border-b border-slate-100">
                    ...
                    <p className="text-sm text-slate-500 mt-1">Latest pharmacy prescriptions awaiting dispensing</p>
                </div>
